...
class Prog(App):
    def build(self):
        ...
        self.lbl1 = Label(text="0", font_size= "50" , color = [1,0,0,1])
        ...
        self.btn3 = Button(text="Zerar", font_size = "25", color = [1,1,1,1], background_color = [0.5,1,0.5,1])
        ...
        self.btn6 = Button(text="Cor", font_size = "25", color = [1,1,1,1], background_color = [0.5,1,0.5,1])
        ...
        self.btn6.on_press = self.AltColor
    ...
    def AltColor(self):
        ...
        if self.lbl1.color == [1,0,0,1]:
            self.lbl1.color = [0,0,1,1]

        elif self.lbl1.color == [0,0,1,1]:
            self.lbl1.color = [0,1,0,1]

        elif self.lbl1.color == [0,1,0,1]:
            self.lbl1.color = [1,0,0,1]
